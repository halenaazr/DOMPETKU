...
<head>
    ...
    <title> Login &mdash; DOMPETKU</title>
            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand">
                        <img src="<?php echo e(asset('assets/img/dompet.svg')); ?>" alt="logoo" width="100" class="shadow-light rounded-circle">
                    </div>
                    ...
                    <div class="mt-5 text-muted text-center">
                        Belum punya akun? <a href="<?php echo e(route('register')); ?>">Buat Sekarang!</a>
                    </div>
...
<?php /**PATH D:\KODING\uangku-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>